...
const perks = [
  { icon: Clock,      text: 'Implantação em até 48 horas' },
    ...
    <section className="py-24 relative overflow-hidden bg-rp-surface">
      <div className="absolute inset-0">
        ...
        <div
          ...
          style={{ background: 'radial-gradient(ellipse 70% 60% at 50% 0%, rgba(24,71,214,0.07) 0%, transparent 70%)' }}
        />
        <div
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <motion.h2
          ...
          className="text-3xl sm:text-5xl lg:text-6xl font-bold text-[#0C1A38] tracking-tight leading-[1.1] mb-5 sm:mb-6"
        >
          Pronto para simplificar o controle{' '}
        ...
        <motion.p
          ...
          className="text-lg text-[#4D5E7A] mb-10 max-w-2xl mx-auto"
        >
          Fale com um consultor e receba uma proposta personalizada para o tamanho da
        ...
        >
          {perks.map(({ icon: Icon, text }) => (
            <div key={text} className="flex items-center gap-2 text-sm text-[#4D5E7A]">
              <Icon size={15} style={{ color: '#1847D6' }} className="flex-shrink-0" />
              {text}
            </div>
          ))}
        </motion.div>
