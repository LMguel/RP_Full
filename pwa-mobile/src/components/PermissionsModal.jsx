    ...
    switch (step) {
      case 'welcome':
        return (
          ...
          >
            <div className="w-20 h-20 mx-auto mb-6 bg-gradient-to-br from-primary-600 to-primary-800 rounded-full flex items-center justify-center">
            ...
            <motion.button
              ...
              className="w-full bg-gradient-to-r from-primary-600 to-primary-800 text-white py-3 rounded-lg font-semibold shadow-lg hover:shadow-xl transition-shadow"
            >
              Continuar
            </motion.button>
            <button
