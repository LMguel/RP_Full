...
export default function FuncionarioLoginPage() {
  ...
  const { signInFuncionario, signed, userType } = useAuth();
  ...
  async function handleLogin(e) {
    ...
    if (!funcionarioId || !senha) {
      setError('Por favor, preencha o ID e a senha.');
      return;
    }
    ...
    try {
      ...
      setError(err.response?.data?.error || err.message || 'ID ou senha inválidos.');
    } finally {
      setLoading(false);
    }
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-900 via-primary-800 to-primary-700 flex flex-col items-center justify-center p-4">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white mb-2">Login Funcionário</h1>
          <p className="text-white/70">Acesse sua conta</p>
        </div>
          ...
          <div className="mb-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="Seu ID de funcionário"
                disabled={loading}
