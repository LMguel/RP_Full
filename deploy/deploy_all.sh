...
S3_FRONT="${S3_BUCKET_FRONT:?S3_BUCKET_FRONT must be set in deploy/.env}"
S3_PWA="${S3_BUCKET_PWA:?S3_BUCKET_PWA must be set in deploy/.env}"
CF_FRONT="${CLOUDFRONT_ID_FRONT:?CLOUDFRONT_ID_FRONT must be set in deploy/.env}"
CF_PWA="${CLOUDFRONT_ID_PWA:?CLOUDFRONT_ID_PWA must be set in deploy/.env}"
...
echo "╠══════════════════════════════════════════════╣"
echo "║  Front:   s3://$S3_FRONT (CF: $CF_FRONT)      ║"
echo "║  PWA:     s3://$S3_PWA (CF: $CF_PWA)         ║"
echo "║  API:     $EC2_HOST                           ║"
echo "╚══════════════════════════════════════════════╝"
echo ""
