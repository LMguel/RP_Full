...
def calculate_daily_balance(
    ...
    """
    Banco de horas do dia: regra única e universal — trabalhado vs. previsto,
    sem exceção. O que exceder o previsto é hora extra (banco positivo); o
    que faltar é saldo negativo. Usado igualmente em todos os modos e em
    todos os pontos de cálculo do sistema (espelho, resumo diário/mensal,
    pré-folha) — não há mais desconto por entrada antecipada nem qualquer
    outra ressalva: o total trabalhado é sempre o que conta.
    ...
    """
    raw_balance = worked_min - expected_min
